...
const Projects = () => {
  return (
    <div
      name="projects"
      className="w-full md:h-screen h-screen:100vh text-gray-300 bg-[#0a192f]"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                TextUtils <br /> • A quick way to analyze your text.
                <p>
                  {" "}
                  • Made in <span className="italic text-pink-300">React</span>
                </p>
              </span>
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                Frontend Design <br /> • Facebook frontend design concept.
                <p>
                  {" "}
                  • Made in{" "}
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                ToDo App <br /> • Go and make your todo list 😉.
                <p>
                  {" "}
                  • Made in <span className="italic text-pink-300">React</span>
                </p>
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                NewsZilla <br /> • Read latest news very conviniently.
                <p>
                  {" "}
                  • Made in{" "}
                  <span className="italic text-pink-300">React , News API</span>
                </p>
              </span>
              <div className="pt-8 text-center">
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                NFT Marketplace <br /> • Go Mint your favourite NFT 😉.
                <p>
                  {" "}
                  • Made in{" "}
                  <span className="italic text-pink-300">React , Solidity</span>
                </p>
              </span>
              <div className="pt-8 text-center">
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-sm font-bold text-white tracking-wider">
                JaiPa eCommerce
                <br /> • Go shop your favourite goodies 😉.
                <p>
                  {" "}
                  • Made in{" "}
                  <span className="italic text-pink-300">
                    NextJS , Tailwind, Mongo <br /> Node
                  </span>
                </p>
              </span>
              <div className="pt-8 text-center">
